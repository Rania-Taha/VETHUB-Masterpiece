                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="datatable table table-hover table-center mb-0" style="border-collapse: collapse; width: 100%; margin-bottom: 10px;">
                                    <colgroup>
                                        <col style="width: 18%;">
                                        <col style="width: 15%;">
                                        <col style="width: 13%;">
                                    ...
                                    <tbody style="font-size: 14px">
                                        @foreach ($user as $item)
                                            <tr  style="color: rgb(30, 30, 30)">
                                                ...
                                                <td class="text-center">{{ Illuminate\Support\Str::limit($item->password, 17) }}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="actions">
                                                        <a class="btn btn-sm bg-success-light" data-toggle="modal" href="#edit_user_{{ $item->id }}">
                                                            <i class="fe fe-pencil"></i> Edit
                                                        </a>
                                                        <a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_user_{{ $item->id }}">

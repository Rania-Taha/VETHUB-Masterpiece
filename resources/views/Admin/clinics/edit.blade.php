                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <textarea class="summernote-simple" name="description" id="description" placeholder="Enter a description"
                                                        style="width: 700px ; height:80px">{{ $clinic->description }}</textarea>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <textarea class="summernote-simple" name="about" id="about" placeholder="Enter a about"
                                                        style="width: 700px ; height:80px">{{ $clinic->about }}</textarea>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <br>
                                                    <textarea class="summernote-simple" name="location" id="location" placeholder="Enter a location"
                                                        style="width: 700px ; height:80px">{{ $clinic->location }}</textarea>
                                                </div>
                                            </div>
                                            @error('location')
                                                <div class="text-danger small">{{ $message }}</div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <br>
                                                    <textarea class="summernote-simple" name="location_map" id="location_map" placeholder="Enter a location map"
                                                        style="width: 700px ; height:80px">{{ $clinic->location_map }}</textarea>
                                                </div>
                                            </div>
                                            @error('location_map')
                                                <div class="text-danger small">{{ $message }}</div>

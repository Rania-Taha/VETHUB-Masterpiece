                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.profile.edit') }}" enctype="multipart/form-data">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            @if ($user->image)
                                <img style="width: 200px; margin-left: 22px;" src="{{ $user->image }}"
                                    alt="user-avatar" class="d-block w-px-120 h-px-120 rounded" id="uploadedAvatar" />
                            @else
                                <!-- Default image if user does not have an image -->
                                <img style="width: 200px; margin-left: 22px;"
                                    src="{{ asset('images/customer/1700005508.png') }}" alt="default-avatar"
                                    class="d-block w-px-120 h-px-120 rounded" id="defaultAvatar" />
                            @endif

      ...
      <div class="col-lg-8 col-md-12">
        <div class="row">
          <div class="col-lg-4 mb-5 brandfooter2">
            ...
            <p><i class="fa fa-phone-alt mr-2"></i>+962 797984747</p>
            <p><i class="fa fa-envelope mr-2"></i>vethub@gmail.com</p>
    ...
    <div class="row">
      <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
        <p class="m-0 text-white">
          &copy; <a class="text-white font-weight-bold" href="#">VetHub</a>.
          All Rights Reserved.
        </p>
      </div>

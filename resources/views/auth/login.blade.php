...
<head>
	...
	background-image: url(https://images.unsplash.com/photo-1576201836106-db1758fd1c97?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGRvZ3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60);

            /* background: -webkit-linear-gradient(to right, #FFC713, #FFC713);
            background: linear-gradient(to right, #FFC713, #FFC713); */
    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-up-container">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                {{-- first name --}}
                <input type="text" name="first_name" :value="old('first_name')" autofocus autocomplete="username"
                    id="first_name" class="form-control form-control-lg" placeholder="Enter your first name" />
                <x-input-error :messages="$errors->get('first_name')" class="mt-2" style="color: red;font-size:12px" />
                {{-- last name --}}
                <input type="text" name="last_name" :value="old('last_name')" autofocus autocomplete="username"
                    id="last_name" class="form-control form-control-lg" placeholder="Enter your last name" />
                <x-input-error :messages="$errors->get('first_name')" class="mt-2" style="color: red;font-size:12px" />
                {{-- email --}}
                ...
                <x-input-error :messages="$errors->get('password')" class="mt-2" style="color: red;font-size:12px" />
                    <br>
                <button type="submit" id="signcheck">             
